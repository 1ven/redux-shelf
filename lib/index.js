...
function createApis(apisConfigList, settings) {
    return mapValues(apisConfigList, function (inputConfig, name) {
        ...
        var constants = helpers_1.createShelfConstants(name, settings.namespace);
    ...
    return mapValues(apis, function (_, name) {
        return {
            getData: function getData(state) {
                return state[reducerName][name].data;
            },
            getLastUpdated: function getLastUpdated(state) {
                return state[reducerName][name].lastUpdated;
            },
            getError: function getError(state) {
                return state[reducerName][name].error;
            },
            isFetching: function isFetching(state) {
                return state[reducerName][name].isFetching;
            },
...
exports.handleSelectors = handleSelectors;

...
var createShelfReducer = function createShelfReducer(_ref, customState, customMap) {
    ...
    return createReducer_1.default(assign_1.default({
        isFetching: false,
        // may be remove these undefined props, as we are will be using interface
        lastUpdated: undefined,
        error: undefined,
        data: undefined
    }, customState), (_createReducer_1$defa = {}, _defineProperty(_createReducer_1$defa, request, function (state, payload) {
        return assign_1.default(state, {
            isFetching: true
        });
    }), _defineProperty(_createReducer_1$defa, success, function (state, payload) {
        return assign_1.default(state, {
            isFetching: false,
    ...
    }), _defineProperty(_createReducer_1$defa, failure, function (state, payload) {
        return assign_1.default(state, {
            isFetching: false,
